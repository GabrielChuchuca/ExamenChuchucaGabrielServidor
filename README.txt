...
a persistence unit "ExamenChuchucaGabrielServidorPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ExamenChuchucaGabrielServidor\pom.xml":
...
artifact ("ExamenChuchucaGabrielServidor.war") is already built. You can build
